...
<!--**********************************
        ...
        ***********************************-->
        <div class="content-body">
            ...
            <div class="row">
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal" id="new">Add New Class</button>
                </div>
        ...
        ***********************************-->
        <div class="modal fade" id="modal">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Class Registration Form</h5>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label ">Sem ID</label>
                                            <div class="col-sm-10">
                                                <select type="text" class="form-control " id="SemID" name = "SemID" placeholder="Select Sem ID">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select type="text" class="form-control " id="facultyID" name = "facultyID" placeholder="Select faculty ID">
