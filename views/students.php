    ...
    <div class="row page-titles mx-0">
        <div class="col p-md-0">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Student Management</a></li>
            </ol>
        </div>
    </div>
    <!-- row -->
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 text-right">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal">Add New Student</button>
            </div>
                ...
                <div class="container-fluid">
                    <form id="form" action="" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="tell" name="tell" placeholder="Enter Student Tell">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">classID</label>
                            <div class="col-sm-10">
